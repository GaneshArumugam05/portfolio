...
const contactInfo = [
  { icon: Mail, label: "Email", value: "ganesh050801@gmail.com", href: "mailto:ganesh050801@gmail.com" },
  { icon: Phone, label: "Phone", value: "+91 70927 73840", href: "tel:+917092773840" },
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_pf5x82l",
        "template_t5df5v4",
        { from_name: formData.name, reply_to: formData.email, message: formData.message, to_name: "Ganesh Arumugam" },
        "pBJ9fSO2R_VtqN9Gt"
      )
      .then(() => {
      ...
      .catch((err) => setSubmitStatus({ type: "error", message: "Failed to send message. Please try again later." }))
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade animation-delay-100 text-secondary-foreground">
            Let's build <span className="font-serif italic font-normal">something great.</span>
          </h2>
                ...
                <div key={i}>
                  ...
                  {field === "message" ? (
                    <textarea
                      ...
                      className="w-full px-4 py-3 bg-surface-light dark:bg-surface-dark text-foreground-light dark:text-foreground-dark placeholder:muted-light dark:placeholder:muted-dark rounded-xl border border-border-light dark:border-border-dark focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all resize-none"
                      disabled={isLoading}
                    />
                  ) : (
                    <input
                      ...
                      name={field}
                      placeholder={field === "email" ? "example@email.com" : "John Doe"}
          ...
          <div className="space-y-6 animate-fade animation-delay-400">
              ...
              <div className="space-y-4">
                {contactInfo.map((item, i) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm text-muted-light dark:text-muted-dark">{item.label}</div>
                      <div className="font-medium text-foreground-light dark:text-foreground-dark">{item.value}</div>
                    </div>
                  </a>
                ))}
              </div>
            ...
            <div className="glass rounded-3xl p-8 border border-primary/30">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="font-medium text-foreground-light dark:text-foreground-dark">Currently Available</span>
              </div>
